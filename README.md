...
- 🔍 **规则级代码审查**，指出常见错误
- ▶️ **Judge0 真编译**（需启动后端），一键运行看 stdout
- 🤖 **LLM 智能提示**（BYOK：自带 OpenAI / Claude / DeepSeek Key），像私人助教一样对话
- 📤 **导出 Markdown 报告**或 **🔗 复制可分享链接**

🌐 **在线演示**：https://github.com/sjkncs/learn-cpp-in-7-days
...
右上角「☀️ 亮色 / 🌙 暗色」一键切换。状态保存在 localStorage。
...
| 真编译 | Judge0 + Express 代理 | 工业级代码执行引擎 |
...
- [x] v1.0：CodeMirror 编辑器 + 提示引擎 + 静态审查
- [x] v1.1：4 个主题 → 10 个主题
- [x] v1.2：导出 Markdown + URL 分享
- [x] v1.3：Judge0 真编译 + Node 代理 + docker-compose
- [x] v1.4：LLM BYOK（OpenAI/Claude/DeepSeek/自定义）
- [ ] v1.5：移动端适配
- [ ] v1.6：进度徽章 + 学习路径
